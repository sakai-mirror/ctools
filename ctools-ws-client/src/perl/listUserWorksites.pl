...
## SakaiSite has getSiteList (private), getSitesDom, getToolsDom
## SakaiScript has getSitesUserCanAccess(String)

## SakaiScript also has addPageToSite, addNewToolToPage, addNewPageToSite, maybe try just assuming there is a site.
## 
