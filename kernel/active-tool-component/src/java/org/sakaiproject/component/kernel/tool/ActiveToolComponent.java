...
public class ActiveToolComponent extends ToolComponent implements ActiveToolManager
{
	...
	public class MyActiveTool extends org.sakaiproject.util.Tool implements ActiveTool
	{
		 ...
		 */
		public MyActiveTool(org.sakaiproject.api.kernel.tool.Tool t)
		{
			super();
		...
		/** 
		 * Return a RequestDispatcher that can be used to dispatch to this tool - 
		 * RequestDispatcher is NOT THREAD-SAFE FOR REUSE, so this method must be called 
		 * each and every time a request is forwarded.
		 */
		...
		public class WrappedRequest extends HttpServletRequestWrapper
		{
			...
			public WrappedRequest(HttpServletRequest req, String context, String path, Placement placement, boolean fragment, Tool tool)
			{
				super(req);
				m_wrappedReq = req;
