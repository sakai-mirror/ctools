/**********************************************************************************
*
* $Header: /cvs/sakai2/legacy/component/src/java/org/sakaiproject/component/legacy/event/ClusterEventTracking.java,v 1.3 2005/05/12 01:38:27 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	implements Runnable
{
	...
	*/
	...
	{
		String statement =
			"select MAX(EVENT_ID) from SAKAI_EVENT";
