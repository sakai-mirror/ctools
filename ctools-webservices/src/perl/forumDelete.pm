...
#   ##############################
  ...
  #my $forumIds = "D\nE";
  # This tests to see if can connect and if can create a session.
  #  my $response = $forumDeleterConnection->deleteForumsTestConnection($sakaiSession,"A","B","C","D");
  # this checks that the arguments are parsed and (probably) useful.
 #   my $response = $forumDeleterConnection->deleteForumsTestArgs($sakaiSession,
 # 							   $sitePageToolIds->siteId,
 # 							   $sitePageToolIds->pageId,
 # 							   $sitePageToolIds->toolId,
 # 							   $forumIds
 ...
 #  my $forumIds = "6728fbf4-8556-48aa-8022-58f4ff7a31eb\ne47794f8-0b1d-4820-00ed-2cc7954ce8a4\ncadf53e4-0361-4d8f-0097-cac12a703591";
...
#   print ("deleting forum: site/page/tool: ",join("/",$context->$siteId,$context->$pageId,$context->$toolId)," forum: ",$forum);
