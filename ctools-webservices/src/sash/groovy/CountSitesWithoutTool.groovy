// $HeadURL: https://source.sakaiproject.org/svn/ctools/trunk/ctools-webservices/src/sash/groovy/UpdateSiteWithTool.groovy $
// $Id: UpdateSiteWithTool.groovy 51567 2008-08-29 14:03:42Z dlhaines@umich.edu $
...
class Driver {
  ...
  def main(String[] args) {
    ...
    def USWT = new CountSitesWithoutTool();
    USWT.perform(cmd);
  }
}
...
class CountSitesWithoutTool {
  ...
  private static Log log = LogFactory.getLog("edu.umich.ctools.CountSitesWithoutTool");
  private static Log metric = LogFactory.getLog("metrics." + "edu.umich.ctools.CountSitesWithoutTool");
