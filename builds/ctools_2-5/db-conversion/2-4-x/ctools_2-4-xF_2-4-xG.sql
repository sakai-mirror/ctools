...
-- code requires this to be done by server, not in advance.  That means that the indices
-- must be moved afterwards by hand.

-- Force this to happen and report problems but having a non failing SQL statement first
-- SELECT 1 FROM DUAL;
