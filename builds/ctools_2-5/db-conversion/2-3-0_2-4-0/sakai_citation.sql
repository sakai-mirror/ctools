...
-- This contains the table and data definitions for the CITATION tool.
-- THe tables have been commented out as they are in the conversion script, but 
-- (incorrectly in my view) the data is not.  This needs to be run to correct 
-- the omission.
-- -----------------------------------------------------------------------------
-- -- CITATION_COLLECTION
-- -----------------------------------------------------------------------------
